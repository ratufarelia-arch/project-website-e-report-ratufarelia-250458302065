...
<head>
  ...
  <link rel="stylesheet" crossorigin href="{{ asset('template/dist 2/assets/compiled/css/auth.css') }}">
</head>

<body>
    <script src="{{ asset('template/dist 2/assets/static/js/initTheme.js') }}"></script>
    <div id="auth">
