            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content p-5">
                        <div class="buttons">
                            <a href="{{ route('form.data-user')}}" class="btn icon icon-left btn-primary"><i data-feather="edit"></i>Tambah Data User</a>
                        </div>
                        <!-- table bordered -->
                                    ...
                                    @foreach ($user as $row)
                                        <tr class="table-active">
                                            ...
                                            <td>
                                                ...
                                                <a href="" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete{{$row->id}}" title="menghapus data"><i class="fa-solid fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
